      ...
      <div className="user-form-box">
        ...
        <div className="form-group-custom">
          ...
          <div className="input-icon-wrap">
            ...
            <input value={username} onChange={(e) => setUsername(e.target.value)} placeholder="Username" maxLength={25} name="username" autoComplete="off" />
          </div>
        </div>
        ...
        <div className="form-group-custom">
          ...
          <div className="input-icon-wrap">
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder={isEdit ? "Kata sandi baru (opsional)" : "Kata sandi"} maxLength={25} name="new-password" autoComplete="new-password" />
          </div>
        </div>
